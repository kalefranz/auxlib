...
python stdlib gaps much like [pytoolz](https://github.com/pytoolz/) has for functional programming,
[pyrsistent](https://github.com/tobgu/pyrsistent/) has for data structures, or
[boltons](https://github.com/mahmoud/boltons/) has generally.
...
Major areas addressed are:
  ...
  - intelligent type coercion utilities (auxlib.type_coercion)
