...
class TestBase64Encoding(TestCase):
    ...
    def test_encode(self):
        ...
        result_str = "TWlja2V5IE1vdXNl"
        self.assertEqual(crypt.as_base64(test_str), result_str)

    def test_encode_unicode(self):
        test_str = u"Mickey Mouseп"
        result_str = "TWlja2V5IE1vdXNl0L8="
        self.assertEqual(crypt.as_base64(test_str),
                         result_str.encode('UTF-8'))

    def test_decode(self):
        test_str = "TWlubmllIE1vdXNl"
        result_str= "Minnie Mouse"
        self.assertEqual(crypt.from_base64(test_str), result_str)
